...
public class FourthActivity extends AppCompatActivity {
    ...
    private float fDimRatio = 0.5f; // 尺寸比例（实际尺寸/xml文件里尺寸）
    @Override
    ...
    private void addContent(View v) {
        ...
        if (iIndex >= 0) {
            ...
            LinearLayout layout = new LinearLayout(FourthActivity.this);
            LinearLayout.LayoutParams lLayoutlayoutParams = new LinearLayout.LayoutParams(
                    ViewGroup.LayoutParams.MATCH_PARENT,
                    ViewGroup.LayoutParams.WRAP_CONTENT);
            // 设置margin
            lLayoutlayoutParams.setMargins(0, (int) (fDimRatio * 2), 0, 0);
            layout.setLayoutParams(lLayoutlayoutParams);
            // 设置属性
            layout.setBackgroundColor(Color.argb(255, 162, 205, 90));   // #FFA2CD5A
            layout.setPadding((int) (fDimRatio * 0.5), (int) (fDimRatio * 0.5),
                    (int) (fDimRatio * 0.5), (int) (fDimRatio * 0.5));
            layout.setOrientation(LinearLayout.VERTICAL);

            // 3.创建“+”和“-”按钮外围控件RelativeLayout
            RelativeLayout rlBtn = new RelativeLayout(FourthActivity.this);
            RelativeLayout.LayoutParams rlParam = new RelativeLayout.LayoutParams(
                    ViewGroup.LayoutParams.MATCH_PARENT,
                    ViewGroup.LayoutParams.WRAP_CONTENT);
//          rlParam.setMargins(0, (int) (fDimRatio * 5), 0, 0);
            rlBtn.setPadding(0, (int) (fDimRatio * 2), 0, 0);
            rlBtn.setLayoutParams(rlParam);
            // 4.创建“+”按钮
            ImageButton btnAdd = new ImageButton(FourthActivity.this);
            ...
            // 5.创建“-”按钮
            ImageButton btnDelete = new ImageButton(FourthActivity.this);
            btnDelete.setBackgroundResource(R.drawable.del);
            RelativeLayout.LayoutParams btnDeleteAddParam = new RelativeLayout.LayoutParams(
                    ViewGroup.LayoutParams.WRAP_CONTENT,
                    ViewGroup.LayoutParams.WRAP_CONTENT);
            btnDeleteAddParam.setMargins(0, 0, (int) (fDimRatio * 2), 0);
            // “-”按钮放在“+”按钮左侧
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.thrid, menu);
        return true;
    }  */
}
